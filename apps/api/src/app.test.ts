...
class NullEnqueueJobPort implements JobPort {
  ...
  async findActiveJobByLogicalKey(kind: JobKind, logicalKey: string): Promise<string | undefined> { return this.delegate.findActiveJobByLogicalKey(kind, logicalKey); }
